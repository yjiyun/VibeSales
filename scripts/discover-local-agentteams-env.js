...
const values={...existing,
 ...
 RUNTIME_MODEL:'dashscope:qwen3.5-plus',NEST_LLM_BASE_URL:gateway+'/v1',NEST_LLM_TOKEN:gatewayKey,RUNTIME_LLM_BASE_URL:gateway+'/v1',RUNTIME_LLM_TOKEN:gatewayKey,
