...
public final class PipelineControlClient {
 ...
 public IssuedRun createRun(String clientCode,String actor)throws IOException,InterruptedException{JsonNode n=send("POST","/api/v1/pipeline/runs",Map.of("client_code",clientCode),"orchestrator",actor);return new IssuedRun(required(n,"run_id"),required(n,"client_code"));}
